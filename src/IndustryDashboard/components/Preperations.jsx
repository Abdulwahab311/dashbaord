  ...
  return (
    <div className="w-full max-w-full p-4">
      ...
      <div className="flex flex-wrap lg:flex-nowrap gap-4 w-full">
        ...
        {/* Gauges */}
        <div className="grid grid-cols-3 gap-2 rounded-lg bg-[#090D28] flex-1 min-w-[200px]">
        ...
        {/* Repeat sections */}
        <div className="rounded-lg bg-[#090D28]">
          <DealDuration dealPhases={dealPhases} />
        </div>

        <div className="grid grid-cols-3 rounded-lg bg-[#090D28] gap-2 flex-1 min-w-[200px]">
          {gauges.map((gauge, index) => (
        ...
        {Array.from({ length: 5 }).map((_, index) => {
          ...
          return (
            <div key={index} className="rounded-lg bg-[#090D28]">
