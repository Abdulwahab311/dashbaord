  ...
  return (
    <div className=" bg-[#181C3A] rounded-2xl py-5 px-2  text-center">
      ...
      <div className="bg-[#0B0F24] rounded-2xl p-2 mb-1">
        <div className="text-white text-xl font-semibold tracking-wide">TOTAL DEALS</div>
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          { title: 'SELF FINANCED', value: 9 },
          { title: 'OTHER DEALS', value: 9 },
          { title: 'INDUSTRY DEALS', value: 9 },
        ].map((k, i) => (
          <div key={i} className="bg-[#090D28] rounded-lg p-4 text-center shadow-[0_0_0_1px_rgba(42,51,88,0.6)]">
            <div className="text-gray-300 text-[8px] tracking-wide mb-1">{k.title}</div>
